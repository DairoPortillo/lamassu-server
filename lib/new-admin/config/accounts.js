...
const { BTC, BCH, DASH, ETH, LTC, USDT, ZEC, XMR, LN, TRX, USDT_TRON, WLD } = COINS
const { bitpay, coinbase, itbit, bitstamp, kraken, binanceus, cex, binance, bitfinex, bitget } = ALL
...
const ALL_ACCOUNTS = [
  ...
  { code: 'bitget', display: 'Bitget', class: TICKER, cryptos: bitget.CRYPTO },
  ...
  { code: 'infura', display: 'Infura/Alchemy', class: WALLET, cryptos: [ETH, USDT, WLD] },
  ...
  { code: 'cuculabs', display: 'Cuculabs', class: WALLET, cryptos: [WLD] },
